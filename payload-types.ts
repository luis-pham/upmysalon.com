...
export interface Page {
  ...
  title: string;
  /**
   * URL slug: home | le-tan-ai-nghe-may-dat-lich | …
   */
  slug: string;
  seo?: {
    title?: string | null;
...
export interface LegalPage {
  id: number;
  /**
   * URL slug: /{slug} (VI) and /en/{slug} (EN)
   */
  slug: 'privacy' | 'terms' | 'sms-consent' | 'refund';
  title: string;
  titleEn: string;
  /**
   * Leave empty to show [NGÀY] / [DATE] placeholders until filled.
   */
